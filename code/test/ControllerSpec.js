...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		// TODO: write test
		let todo1 = {title: 'my todo', completed: false};
		let todo2 = {title: 'my other todo', completed: true};
	...
	describe('routing', function () {
		...
		// modif
		// devrait afficher les entrées actives (controller 74)
		...
		// modif
		// devrait montrer les entrées complétées (controller 84)
	...
	// modif
	// devrait mettre en surbrillance le filtre "Tous" par défaut
	...
	// modif
	// devrait mettre en surbrillance le filtre "Actif" lors du passage à la vue active
	...
	describe('toggle all', function () {
		// modif
		// devrait basculer toutes les tâches à terminer (controller 219)
		it('should toggle all todos to completed', function () {
			// TODO: write test
			let todo = {id: 42, title: 'my todo', completed: false};
	...
	describe('new todo', function () {
		//modif
		//devrait ajouter une nouvelle tâche au modèle (model 15)
		it('should add a new todo to the model', function () {
			...
			let newTodo = {title: 'myTodo', completed: false};
	...
	describe('element removal', function () {
		//modif
		//devrait supprimer une entrée du modèle (controller 158)
		it('should remove an entry from the model', function () {
			// TODO: write test
			let todo = {id: 52, title: 'my todo', completed: true};
			setUpModel([todo]);

			subject.setView('');
			
			subject.removeItem(52);
